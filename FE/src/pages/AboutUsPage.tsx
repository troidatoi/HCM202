  ...
  const aiTools = [
    {
      ...
      title: 'ChatGPT',
      description: 'Hỗ trợ nghiên cứu Quyền con người trong XHCN và tạo nội dung tạp chí chất lượng cao',
      color: 'text-amber-600'
    },
    {
      icon: <FaRobot size={40} />,
      title: 'Gemini Chat',
      description: 'Trợ lý AI tích hợp sẵn trong website, hỗ trợ trả lời câu hỏi về Quyền con người 24/7',
    ...
    },
    {
      ...
      title: 'Lovart',
      description: 'Tạo hình ảnh AI minh họa cho quyền con người trong XHCN',
      color: 'text-amber-600'
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-10 pb-16">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between mb-20 gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                <h1 className="relative text-6xl md:text-8xl font-bold uppercase text-center bg-gradient-to-r from-amber-700 via-amber-800 to-amber-900 bg-clip-text text-transparent animate-pulse font-serif">
                  About Us
                </h1>
              </motion.div>
              ...
              >
                ...
                <div className="inline-block bg-gradient-to-r from-amber-100/50 to-amber-100/50 backdrop-blur-sm rounded-2xl p-6 border border-amber-200 shadow-lg">
                  <p className="text-lg text-amber-900 font-medium">
                    Tạp chí số Quyền con người trong XHCN - Tìm hiểu về Dân chủ XHCN và Nhà nước XHCN
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-amber-400/30 to-amber-400/30 rounded-3xl blur-2xl transform -rotate-3"></div>
                <div className="relative w-[340px] md:w-[420px] aspect-square bg-amber-900 rounded-3xl shadow-2xl border-2 border-amber-200/50 transform hover:scale-105 transition-all duration-500 flex items-center justify-center text-white text-9xl">
                  VN
                </div>
              </div>
            </motion.div>
        ...
        >
          <div className="mb-20 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/10 to-amber-500/10 rounded-3xl blur-3xl"></div>
            <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-8 border border-amber-200 shadow-2xl font-serif">
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-amber-800 to-amber-950 rounded-full mb-4 shadow-lg text-white">
                  <span className="text-2xl font-bold">5.3</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-800 to-amber-950 bg-clip-text text-transparent mb-4">
                  Về Dự Án Tạp Chí Số
                </h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-amber-600 to-amber-800 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-white text-sm">1</span>
                    </div>
                    <p className="text-gray-800 leading-relaxed">
                      Dự án này được thực hiện bởi <span className="text-amber-800 font-semibold">Group5</span> chuyên sâu về <span className="text-amber-700 font-semibold">Quyền con người trong XHCN Chương 4</span>.
                    </p>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-white text-sm">2</span>
                    </div>
                    <p className="text-gray-800 leading-relaxed">
                      Chúng tôi đã phát triển một <span className="text-amber-800 font-semibold">tạp chí kỹ thuật số</span> tích hợp quizz và trò chơi tương tác.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-amber-700 to-amber-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-white text-sm">3</span>
                    </div>
                    <p className="text-gray-800 leading-relaxed">
                      Hướng đến việc <span className="text-amber-800 font-semibold">hiện đại hóa cách tiếp cận</span> lý luận chính trị và tư tưởng bác Hồ.
                    </p>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-amber-900 to-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-white text-sm">4</span>
                    </div>
                    <p className="text-gray-800 leading-relaxed">
                      Mang lại trải nghiệm <span className="text-amber-800 font-semibold">cao cấp và trực quan</span> cho sinh viên trường Đại học FPT.
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              ...
              <h2 className="relative text-4xl md:text-5xl font-bold bg-gradient-to-r from-amber-700 via-amber-800 to-amber-950 bg-clip-text text-transparent mb-6">
                Thành Viên Nhóm
              </h2>
              <p className="text-xl text-amber-900/80 max-w-3xl mx-auto font-serif">
                Đội ngũ chuyên nòng cốt trong dự án nghiên cứu Quyền con người trong XHCN
              </p>
            </motion.div>
          </div>
        ...
        >
          <div className="text-center mb-12 mt-24">
            ...
            <p className="text-lg text-amber-800 max-w-2xl mx-auto font-serif">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.6 }}
        >
          <div className="mt-24 p-10 bg-gradient-to-br from-amber-900 to-amber-950 text-white rounded-3xl border-2 border-amber-500/50 shadow-2xl font-serif">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-amber-500">Muc Tieu Du An Chuong 4</h2>
            <p className="text-lg md:text-xl mb-6 leading-relaxed">
              Du an MLN131 cua <span className="text-amber-400 font-bold">Group5</span> khong chi dung lai o viec hoc tap ly thuyet, ma con truyen tai tinh than <span className="text-amber-400 font-bold">Quyen con nguoi trong XHCN</span> thong qua nen tang so hoa. Chung toi mong muon xay dung mot khong gian hoc tap truc quan, sinh dong, noi moi sinh vien co the de dang tiep thu va van dung kien thuc ve dan chu XHCN va nha nuoc XHCN trong cuoc song va cong viec tuong lai.
            </p>
