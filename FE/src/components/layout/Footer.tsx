...
function Footer() {
  return (
    <footer className="relative bg-gradient-to-t from-red-100 via-red-50 to-white text-red-900 pt-16 pb-24 px-4 md:px-20 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-0 justify-between items-start">
        ...
        <div className="flex-1 min-w-[220px] flex flex-col items-center md:items-start">
          <div className="text-4xl font-semibold font-serif mb-8 text-red-900">Tạp chí Hùng</div>
        ...
        <div className="flex-[2] grid grid-cols-2 md:grid-cols-4 gap-8 w-full">
          <div>
            ...
            <ul className="space-y-3 text-base">
              ...
              <li><a href="/magazine" className="hover:underline">Tạp chí số</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-base">
              <li><a href="#" className="hover:underline">Đại đoàn kết dân tộc</a></li>
              <li><a href="#" className="hover:underline">Đoàn kết quốc tế</a></li>
              <li><a href="#" className="hover:underline">Chương 5.3</a></li>
      ...
      <div className="mt-16 border-t border-primary-200 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-primary">
        <div>
          @2026 - Tạp chí Hùng. Nền tảng nghiên cứu Tư tưởng Hồ Chí Minh
        </div>
